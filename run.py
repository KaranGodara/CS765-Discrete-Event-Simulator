...
def main():
    ...
    parser.add_argument('--I', type=float, default=1, help='Mean interarrival time between blocks (in s)')
    parser.add_argument('--T_sim', type=int, default=10000, help='Simulation time (in s)')
    # note I is in secs
